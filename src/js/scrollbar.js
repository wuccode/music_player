//自动生成滚动条
function ScrollBar({div,width = 10,bgColor = 'rgba(255, 255, 255, 0.242)'}){
    this.newDiv = div;
    this.width = width;
...
ScrollBar.prototype.createDiv = function createDiv() {
...
ScrollBar.prototype.divHeight = function divHeight() {
    let contentHeight;
...
ScrollBar.prototype.updateTop = function (){
...
ScrollBar.prototype.scrollBarWheel = function scrollBarWheel() {
...
ScrollBar.prototype.scrollBarDown = function scrollBarDown() {
